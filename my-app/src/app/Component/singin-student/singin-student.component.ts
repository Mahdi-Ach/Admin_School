...
@Component({
  selector: 'app-singin-student',
  templateUrl: './singin-student.component.html',
  styleUrls: ['./singin-student.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class SinginStudentComponent {
  ...
  submitStudentSection(e:any){
    ...
    if(this.singinstudentsection.valid){
      ...
      console.log(form)
      this.crudStudent.create(form,'http://localhost:8080/Student/create_student').subscribe(res=>{
