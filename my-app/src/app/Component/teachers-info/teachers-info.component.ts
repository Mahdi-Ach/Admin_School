...
export class TeachersInfoComponent {
  ...
  ngOnInit(): void {
    this.crudService.getStudentDetail('http://localhost:8080/Teacher/Detail_teacher?Teacher_id='+this.activatedRouter.snapshot.queryParamMap.get("Teacher_id")).subscribe(res=>{
      ...
      this.Profile = new FormGroup({
        ...
        cin: new FormControl({ value: res["cin"], disabled: true }),
      ...
      this.default_data["cin"] = this.Profile.controls["cin"].value
  ...
  Edit_Save(eve:any){
    ...
    if(eve.innerHTML == "Edit"){
      ...
      form.append("cin",this.Profile.controls['cin'].value)
      ...
      this.crudService.updateStudent("http://localhost:8080/Teacher/Update_teacher/"+this.Profile.controls["id"].value,form).subscribe({
  ...
  onFileSelected(event) {
    ...
    this.crudService.updateStudentdata("http://localhost:8080/Teacher/update_teacher/"+event.target.dataset["value"]+"/"+
  ...
  Update_input(e:any){
    this.crudService.updateStudentdata("http://localhost:8080/Teacher/update_teacher/"+e.target.dataset["value"]+"/"+
